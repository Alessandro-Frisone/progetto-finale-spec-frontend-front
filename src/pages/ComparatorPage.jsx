      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Confronta le caratteristiche delle tue auto selezionate per fare la
            scelta migliore
          </p>
        </div>
            ...
            >
              ...
              {category.specs.map((spec, specIndex) => {
                ...
                return (
                  <div
                    key={specIndex}
                    className="grid grid-cols-1 lg:grid-cols-3 border-b border-gray-100 last:border-b-0"
                  >
                    {/* Spec Label */}
                    ...
                    {/* Car 1 Value */}
                    <div
                      className={`p-6 flex items-center border-r border-gray-100 lg:border-r-0 ${
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          className={`text-gray-800 font-medium ${
                            isBetter1 ? "text-green-700 font-bold" : ""
                          }`}
                        >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          className={`text-gray-800 font-medium ${
                            isBetter2 ? "text-green-700 font-bold" : ""
                          }`}
                        >
